...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MySortFilterProxyModel_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_MySortFilterProxyModel_t qt_meta_stringdata_MySortFilterProxyModel = {
    {
QT_MOC_LITERAL(0, 22) // "MySortFilterProxyModel"
...
const QMetaObject MySortFilterProxyModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_MySortFilterProxyModel.offsetsAndSize,
    qt_meta_data_MySortFilterProxyModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_MySortFilterProxyModel_t
